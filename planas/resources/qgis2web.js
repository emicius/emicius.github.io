...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [582746.908439, 6065307.338852, 582974.949008, 6065391.220688], maxZoom: 28, minZoom: 1, projection: 'EPSG:3346'
    })
});
map.getView().fit([582746.908439, 6065307.338852, 582974.949008, 6065391.220688], map.getSize());
